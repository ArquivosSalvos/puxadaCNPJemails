...
const API_KEY = '95e91fa0-512e-40b6-add7-4aa046bdc06e-64d661a7-c34f-43e5-bd01-b317defc21fd';
...
function exportEmails() {
    ...
    alert(`Exportação de emails concluída! ${exportData.length} registro(s) exportado(s).`);
}
